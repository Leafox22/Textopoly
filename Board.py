...
def printBoard():
    ...
    print("|{}|                                "+fg(1)+"|__   __|"+ attr("reset")+"      "+fg(3)+"| |"+ attr("reset")+"                   "+fg(13)+"| |"+ attr("reset")+"                       |{}|".format(" ".join(boardSpace[36]).center(cf(36)), " ".join(boardSpace[14]).center(cf(14))))
    ...
    print("|{}|                                                         "+fg(76)+"| |"+ attr("reset")+"             "+fg(54)+"__/ |"+ attr("reset")+"                 |{}|".format(" ".join(boardSpace[35]).center(cf(35)), " ".join(boardSpace[15]).center(cf(15))))
